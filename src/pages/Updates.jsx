import { Sparkles, Plus, Wrench, Zap, Bug, Megaphone, Search, FileText, BarChart3, BellRing, ScanLine, FileCheck2, Bookmark, Type, Filter as FilterIcon, Hash, Calendar, ListFilter, EyeOff, Trash2, Lock, Shield, UserCog, Palette, Activity, Database, MessageCircle, Network, Sliders, X, Pencil, Info } from 'lucide-react'
...
const UPDATES = [
  {
    ...
    summary: 'تحديث ضخم يركز على تسريع إدخال الفواتير والتحكم بالعرض. أضفنا نمط الإدخال اليدوي للفواتير اللي ما تحتاج ذكاء اصطناعي، مع نظام قوالب سريعة يخليك ترسل فواتير متكررة بضغطة واحدة. صفحة الفواتير صار فيها فلترة متقدمة (تاريخ، مبلغ، مورد) وتقسيم صفحات. لوحة الإشعارات صارت فيها فلترة بالنوع وزر مسح. وأضفنا صفحة "تحديثات النظام" نفسها اللي تشوفها الآن.',
    items: [
